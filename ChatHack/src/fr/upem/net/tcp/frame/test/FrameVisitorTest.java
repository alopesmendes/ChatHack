...
public class FrameVisitorTest {
	...
	void testSameFrameVisitor() {
		...
		fv1.when(Data.DataGlobalClient.class, d -> Frame.createFrameGlobal(d));
		fv2.when(Data.DataGlobalClient.class, d -> Frame.createFrameGlobal(d));
		fv3.when(Data.DataGlobalClient.class, d -> Frame.createFrameGlobal(d));
