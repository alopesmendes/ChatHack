...
public class FrameGlobalReceivingReader implements Reader<Frame> {

	
	private enum State {
		DONE, WAITING_OP_CODE,WAITING_STEP, WAITING_LOGIN, WAITING_TEXT, ERROR
	}
	 ...
	 * @param bb
	 */
	public FrameGlobalReceivingReader(ByteBuffer bb) {
